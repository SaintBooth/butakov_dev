  ...
  return (
    <header className="fixed w-full z-50 top-0 border-b border-white/40 bg-white/60 backdrop-blur-2xl shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <nav className="flex justify-between items-center h-16 md:h-24" aria-label="Главная навигация">
          <div
          ...
          <div className="hidden md:flex space-x-8 items-center">
            <a href="#services" className="text-sm font-semibold text-slate-600 hover:text-teal-600 transition-colors">Стек и Услуги</a>
            <a href="#b2b" className="text-sm font-semibold text-slate-600 hover:text-teal-600 transition-colors">B2B Партнерство</a>
            <a href="#cases" className="text-sm font-semibold text-slate-600 hover:text-teal-600 transition-colors">Кейсы</a>
            <a href="#experience" className="text-sm font-semibold text-slate-600 hover:text-teal-600 transition-colors">Опыт</a>
            <button
              onClick={onContactClick}
