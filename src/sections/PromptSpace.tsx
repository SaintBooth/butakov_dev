        ...
        <div className="bg-slate-800/40 border border-slate-600/30 rounded-[2.5rem] p-8 md:p-12 lg:p-16 backdrop-blur-xl flex flex-col lg:flex-row items-center gap-12 shadow-[0_8px_32px_rgba(0,0,0,0.4)] relative overflow-hidden">
            ...
            <div className="mt-6 p-5 rounded-2xl bg-slate-900/50 border border-slate-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-2">
                {TECH_STACK.map((tech) => (
                  <span
                    key={tech}
                    className="px-2.5 py-1 bg-slate-800 border border-slate-600 text-teal-300 text-xs font-bold rounded-md"
                  >
                    {tech}
                  </span>
                ))}
          ...
          <div className="lg:w-[45%] w-full">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block relative w-full aspect-[4/3] rounded-[2rem] overflow-hidden bg-gradient-to-br from-slate-900 to-slate-800 border border-slate-700 shadow-2xl group flex items-center justify-center cursor-pointer"
            >
              ...
              <div className="relative z-20 text-center px-6 transform group-hover:scale-105 transition-transform duration-500">
                ...
                <h3 className="text-3xl font-extrabold text-white mb-2 tracking-tight">
                  PromptSpace<span className="text-teal-400">.ru</span>
                </h3>
              </div>
            </a>
          </div>
