...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-v_ff+mtsb1_=1ak^!su-ptul-@@fcm95!ybl_yqs(cxhu8tj%t')
...
REST_FRAMEWORK = {
    ...
    # Global throttling disabled; throttling applied per-view (e.g., contact form)
